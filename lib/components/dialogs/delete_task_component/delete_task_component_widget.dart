...
class DeleteTaskComponentWidget extends StatefulWidget {
  ...
  @override
  _DeleteTaskComponentWidgetState createState() =>
      _DeleteTaskComponentWidgetState();
}

class _DeleteTaskComponentWidgetState extends State<DeleteTaskComponentWidget> {
  late DeleteTaskComponentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DeleteTaskComponentModel());
  }
