...
class GoalsRow extends SupabaseDataRow {
  ...
  int get noTasksComplete => getField<int>('no_tasks_complete')!;
  set noTasksComplete(int value) => setField<int>('no_tasks_complete', value);

  List<String> get goalSharingUsers =>
      getListField<String>('goal_sharing_users');
  set goalSharingUsers(List<String>? value) =>
      setListField<String>('goal_sharing_users', value);
}
